                ...
                <header className="flex shrink-0 items-center justify-between gap-4 border-b border-neutral-800 px-5 p-4 sm:py-5 sm:px-6">
                  <div className="flex min-w-0 items-center gap-4">
                    <div className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-2.5">
                      <IconAlarmPlus className="size-5 text-amber-400" />
                    </div>

                    <div className="min-w-0">
                      <p className="text-[11px] font-semibold uppercase tracking-wide text-amber-300">Link expiration</p>
                      <h1 className="truncate text-lg font-semibold text-white sm:text-xl">Add expiration</h1>
                    </div>
                  </div>
                ...
                <section className="min-h-0 flex-1 overflow-y-auto p-6">
                  <div className="flex flex-col gap-4">
                    <div className="pb-1">
                      ...
                      <p className="text-sm text-neutral-500">Choose when this SmLink should stop being accessible.</p>
                    </div>
                    ...
                    <article className="flex items-center rounded-lg border-1.5 border-neutral-800 bg-neutral-900/80 text-sm focus-within:border-amber-400">
                      <IconCalendarPlus className="ml-3 size-5 text-neutral-500" />
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                      ...
                      <article className="flex items-center rounded-lg border-1.5 border-neutral-800 bg-neutral-900/80 text-sm focus-within:border-amber-400">
                        <IconClockHour3 className="ml-3 size-5 text-neutral-500" />
