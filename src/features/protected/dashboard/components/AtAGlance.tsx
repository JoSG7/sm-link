      ...
      <div className="grid gap-4 p-5 sm:p-6">
        <div className="flex items-center gap-3 rounded-xl border border-neutral-800 bg-neutral-900/50 p-4">
          ...
          <span className="min-w-0 flex-1">
            <span className="block text-sm text-neutral-400">Expired links</span>
        ...
        <div className="flex items-center gap-3 rounded-xl border border-neutral-800 bg-neutral-900/50 p-4">
          ...
          <span className="min-w-0 flex-1">
            <span className="block text-sm text-neutral-400">Protected links</span>
            <span className="mt-1 block text-xl font-semibold text-neutral-100">
        ...
        <div className="pt-2">
          ...
          {latestLink && latestVisitedAt ? (
            <Link
              href={`/dashboard/analytics/${latestLink.short}`}
              className="mt-3 block truncate text-sm text-neutral-300 hover:text-green-300"
            >
              /{latestLink.short} visited {formatDate(latestVisitedAt)}
            </Link>
          ) : (
