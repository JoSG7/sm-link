...
export function HeroTitle() {
  ...
  return (
    <div className="pb-6 text-left sm:pb-16 lg:my-auto lg:shrink-0 lg:pb-2">
      ...
      {/* Title */}
      <h1 className="text-4xl font-normal leading-[1.1] tracking-tight text-white sm:text-[3.25rem]">
        The
