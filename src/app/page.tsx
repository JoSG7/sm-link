...
const HomeTitle = () => {
  ...
  return (
    ...
    <section className="py-14 relative z-0 flex justify-center">
      ...
      md:via-purple-800/30 lg-2:via-sky-800/30"></div>

      <div className="relative w-[94%] max-w-[1080px] z-10 flex gap-3 text-center justify-center lg-2:justify-between">

        <img src="svg/rocket.svg" alt="rocket" className="size-[280px] duration-500 hidden md:block lg:size-[380px] lg-2:hidden"/>
        <img src="svg/linkSharing.svg" alt="share" className="size-[430px] duration-500 hidden lg-2:block" />
        ...
        <div className="flex justify-center items-center">
          ...
          <div className="text-gray-300 sm:text-xl lg:text-2xl lg-2:text-3xl">
            ...
            sm:text-7xl md:from-purple-400 md:to-purple-900 lg:text-8xl lg-2:text-9xl lg-2:from-sky-300 lg-2:to-blue-700"
...
const LoginTitle = () => {
  ...
  return(
    ...
    <section className="py-14 z-0 sm:py-20 lg-2:py-32">
      ...
      <div className="relative z-10 text-center flex gap-7 justify-center lg-2:gap-10">
        ...
        <div className="flex justify-center items-center">
          ...
          <div>
            ...
            sm:text-7xl md:from-purple-400 md:to-purple-900 lg:text-8xl lg-2:text-9xl lg-2:from-sky-400 lg-2:to-blue-900"
            style={{WebkitTextFillColor: "transparent", WebkitBackgroundClip: "text"}}>
              Log in <br /> to start
            </h1>
          </div>
        ...
        <img src="svg/login.svg" alt="rocket" className="size-[280px] hidden md:block lg:size-[380px] lg-2:hidden"/>
        <img src="svg/auth.svg" alt="auth" className="size-[430px] hidden lg-2:block"/>
...
export default async function Home() {
  ...
  if(user){
    ...
    return (
      ...
      <main className="flex flex-col bg-[#001413] text-white md:bg-[#0e051a] lg-2:bg-[#040f1e]">
        <NavBar />
        <div>
