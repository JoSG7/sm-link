...
export function NavBar() {
  ...
  return (
    ...
    <motion.header className="flex py-5 bg-[rgba(0,0,0,0.7)] border-b border-graphite sticky top-0 left-0 right-0 justify-center z-10
    backdrop-blur-sm 3xl:py-6 4xl:py-8 "
