      ...
      <div className="w-[90vw] lg-2:w-full lg-2:py-9 lg-2:max-w-5xl lg-2:flex lg-2:flex-row-reverse lg-2:justify-between">
        ...
        <article className="lg-2:max-w-[580px]">
          <div className="py-7 lg-2:py-12">
            ...
            <h1 className="text-4xl tracking-tight text-center lg-2:text-start lg-2:text-6xl">The smartest way to share your links</h1>

            <p className="text-neutral-400 text-center py-5 lg-2:text-start lg-2:text-xl lg-2:font-medium">
              Tired of messy URLs? Shorten links in seconds and track their performance
              <span className="hidden lg-2:inline"> anytime - 24 hours a day</span>
            </p>
            ...
            <div className="flex items-center gap-4 justify-center lg-2:gap-7 lg-2:justify-start">
              <button className="py-2 px-5 text-base hidden lg-2:block lg-2:py-2 lg-2:px-4 rounded-full bg-gradient-to-r from-neutral-100 to-neutral-400 text-neutral-950 transition-transform duration-200 hover:scale-105">{`Let's start now!`}</button>
