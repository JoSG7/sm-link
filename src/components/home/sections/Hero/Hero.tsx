      ...
      lg-2:w-full lg-2:py-9 lg-2:max-w-5xl lg-2:flex lg-2:flex-row-reverse lg-2:justify-between">
        ...
        <article className="lg-2:max-w-[580px]">
          <div className="py-7 lg-2:py-12">
            ...
            <h1 className="pt-2 tracking-tight text-center text-4xl-fluid lg-2:text-white lg-2:text-start lg-2:text-6xl">
              The <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">smartest way </span> 
              to share your links
            </h1>

            <p className="py-5 text-center text-neutral-300 text-lg-fluid lg-2:text-start lg-2:text-xl lg-2:text-neutral-400 lg-2:font-medium">
            ...
            <div className="flex gap-5 pb-6 sm:justify-normal sm:gap-5 lg-2:hidden">
              <article className="relative p-2 border rounded-lg bg-neutral-950 border-graphite grow">
                <div className="flex justify-center pb-2">
                  <div className="">
                    <IconShieldCheckFilled className="text-green-400 sm:size-7" />
                  </div>
                </div>
                <p className="text-center text-xs-fluid sm:text-base">Protection</p>
              </article>
              ...
              <article className="relative p-2 border rounded-lg bg-neutral-950 border-graphite grow">
                ...
                <p className="text-center text-xs-fluid sm:text-base">Expirations</p>
              </article>
              ...
              <article className="relative p-2 border rounded-lg bg-neutral-950 border-graphite grow">
                ...
                <p className="text-center text-xs-fluid sm:text-base">Settings </p>
              </article>
            </div>
            ...
            <div className="flex items-center justify-center gap-4 sm:justify-start lg-2:gap-7 lg-2:justify-start">
              <button className="py-2 font-medium transition-transform duration-200 rounded-full px-7 text-lg-fluid bg-gradient-to-r from-green-400 to-blue-500 text-neutral-200 hover:scale-105 sm:text-xl sm:py-4 sm:px-5 lg-2:py-2 lg-2:px-4 lg-2:text-lg lg-2:from-green-500 lg-2:to-blue-600"
