...
export function LinkFormTitle() {
  ...
  return (
    ...
    <section className="flex items-center lg:w-[55%] lg-2:w-[48%]">
      <div className="lg-2:py-0">
        ...
        {/* Title for desktop */}
        <h1 className="hidden tracking-tight text-6xl-desktop-sm text-start lg:block lg-2:text-6xl-desktop">
          Shorten <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 ">your first </span> link in seconds
        </h1>

        {/* Paragraph */}
        <p className="py-5 font-medium text-center text-lg-movil text-neutral-300 xs:pb-6 sm:pb-7
        ...
        <section className="hidden lg:block">
          ...
          <div className="flex gap-4 lg-2:gap-5 2xl:gap-6 3xl:gap-7 4xl:gap-9">
            <article className="border rounded-lg bg-neutral-950 border-graphite py-3 px-4 grow
