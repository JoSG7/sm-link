export function LinkFormTitle() {
  ...
  return (
    ...
    <section className="flex items-center">
      <div className="w-[90vw] lg-2:max-w-[500px] lg-2:py-0">
        <h1 className="tracking-tight text-center text-4xl-movil lg-2:text-start lg-2:text-6xl">
        ...
        lg-2:pb-0 lg-2:text-xl lg-2:text-neutral-400 lg-2:text-start">
