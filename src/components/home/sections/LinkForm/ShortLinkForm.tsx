    ...
    sm:p-7 lg:p-6 lg-2:p-7 lg-2:bg-black">
      ...
      <div className="flex justify-between">
        <label htmlFor="txtUrl" className="flex items-center gap-3">
          ...
          <span className="text-lg sm:text-xl font-semibold">Paste a long link</span>
        </label>
      </div>

      <input type="url" autoComplete="off" value={originalLink} onChange={(e) => setOriginalLink(e.currentTarget.value)}
        className="w-full py-2 px-4 my-4 border border-neutral-800 text-neutral-400 bg-neutral-900 rounded-lg
        placeholder:text-neutral-700 sm:text-md sm:my-5 lg:p-3 lg-2:py-3 lg-2:bg-neutral-950"
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-lg sm:text-xl font-semibold">Here is the new link</span>
      </div>
