...
export function ShortLinkForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="relative border p-4-fluid rounded-xl border-graphite bg-neutral-950/70 backdrop-blur-sm sm:p-7 lg:p-6 lg-2:p-7 lg-2:bg-black">
      {/* Borders */}
      ...
      <input type="url" autoComplete="off" value={originalLink} onChange={(e) => setOriginalLink(e.currentTarget.value)}
        className="w-full px-4 py-2 my-4 border rounded-lg text-base-fluid border-neutral-800 text-neutral-400 bg-neutral-900 placeholder:text-neutral-700 sm:text-md sm:my-5 lg:p-3 lg-2:py-3 lg-2:bg-neutral-950 lg-2:text-lg" 
      ...
      <div className="w-full px-4 py-2 my-4 mb-5 border rounded-lg bg-neutral-900 border-neutral-800 text-neutral-300 sm:mt-5 lg:p-3 lg-2:py-3 lg-2:bg-neutral-950">
      ...
      <p className="text-center text-xs-fluid text-neutral-400 sm:text-sm lg-2:text-xs">
