  ...
  return (
    ...
    <section className="p-4 py-5 border-t border-[#1c1d1d] flex justify-center">
      <div className="w-full lg-2:max-w-5xl">
        ...
        <div className="flex gap-4 font-medium text-sm-fluid lg-2:text-lg">
          <span>Privacy Police</span> <span>Terms of Service</span> <span>License</span>
        </div>

        <p className="pt-1 font-medium text-neutral-400 text-sm-fluid lg-2:text-lg">@2025 SmLink. All Rights Reserved</p>
      </div>
    </section>
